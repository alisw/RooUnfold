...
IF( ROOT_CONFIG_EXECUTABLE )
	...
	IF( ${ROOT_VERSION_MAJOR} EQUAL 6 OR  ${ROOT_VERSION_MAJOR} GREATER 6)
		set(ROOT_CINT_EXE_NAME rootcling)
	ELSE()
		set(ROOT_CINT_EXE_NAME rootcint)
	ENDIF()
	FIND_PROGRAM( ROOT_CINT_EXECUTABLE ${ROOT_CINT_EXE_NAME} PATHS ${ROOT_DIR}/bin NO_DEFAULT_PATH )
	IF( NOT ROOT_DIR )
	    FIND_PROGRAM( ROOT_CINT_EXECUTABLE ${ROOT_CINT_EXE_NAME} )
	ENDIF()
